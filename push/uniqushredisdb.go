...
func NewUniqushRedisDB(c *DatabaseConfig) (*UniqushRedisDB, error) {
	if c == nil {
...
func (r *UniqushRedisDB) GetDeliveryPoint(name string) (*DeliveryPoint, error) {
...
func (r *UniqushRedisDB) SetDeliveryPoint(dp *DeliveryPoint) error {
	err := r.client.Set(DELIVERY_POINT_PREFIX+dp.Name(), deliveryPointToValue(dp))
	return err
}

func (r *UniqushRedisDB) GetPushServiceProvider(name string) (*PushServiceProvider, error) {
...
func (r *UniqushRedisDB) SetPushServiceProvider(psp *PushServiceProvider) error {
	return r.client.Set(PUSH_SERVICE_PROVIDER_PREFIX+psp.Name(), pushServiceProviderToValue(psp))
}

func (r *UniqushRedisDB) RemoveDeliveryPoint(dp *DeliveryPoint) error {
	_, err := r.client.Del(DELIVERY_POINT_PREFIX + dp.Name())
	return err
}

func (r *UniqushRedisDB) RemovePushServiceProvider(psp *PushServiceProvider) error {
	_, err := r.client.Del(PUSH_SERVICE_PROVIDER_PREFIX + psp.Name())
	return err
}

func (r *UniqushRedisDB) GetDeliveryPointsNameByServiceSubscriber(srv, usr string) ([]string, error) {
...
func (r *UniqushRedisDB) GetPushServiceProviderNameByServiceDeliveryPoint(srv, dp string) (string, error) {
...
func (r *UniqushRedisDB) AddDeliveryPointToServiceSubscriber(srv, sub, dp string) error {
...
func (r *UniqushRedisDB) RemoveDeliveryPointFromServiceSubscriber(srv, sub, dp string) error {
...
func (r *UniqushRedisDB) SetPushServiceProviderOfServiceDeliveryPoint(srv, dp, psp string) error {
	return r.client.Set(SERVICE_DELIVERY_POINT_TO_PUSH_SERVICE_RPVIDER_PREFIX+srv+":"+dp, []byte(psp))
}

func (r *UniqushRedisDB) RemovePushServiceProviderOfServiceDeliveryPoint(srv, dp string) error {
	_, err := r.client.Del(SERVICE_DELIVERY_POINT_TO_PUSH_SERVICE_RPVIDER_PREFIX + srv + ":" + dp)
	return err
}

func (r *UniqushRedisDB) GetPushServiceProvidersByService(srv string) ([]string, error) {
...
func (r *UniqushRedisDB) RemovePushServiceProviderFromService(srv, psp string) error {
	_, err := r.client.Srem(SERVICE_TO_PUSH_SERVICE_PROVIDERS_PREFIX+srv, []byte(psp))
	return err
}

func (r *UniqushRedisDB) AddPushServiceProviderToService(srv, psp string) error {
	_, err := r.client.Sadd(SERVICE_TO_PUSH_SERVICE_PROVIDERS_PREFIX+srv, []byte(psp))
	return err
}

func (r *UniqushRedisDB) FlushCache() error {
