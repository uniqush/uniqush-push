...
// APNSNotification contains the unserialized binary notification. It represents the unserialization generated by the mock server.
...
func (notification *APNSNotification) String() string {
...
func (netConn *MockNetConn) ReadNotification() (notif *APNSNotification, err error) {
